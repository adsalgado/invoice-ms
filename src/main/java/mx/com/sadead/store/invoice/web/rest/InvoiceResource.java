...
import mx.com.sadead.store.invoice.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link mx.com.sadead.store.invoice.domain.Invoice}.
 */
@RestController
@RequestMapping("/api")
